...
//     });
//
//     it('should update state according to a successful fetch usertemp request', () => {
//       const payload = { data: 'some handsome usertemp' };
...
//       testMultipleTypes([SUCCESS(ACTION_TYPES.CREATE_USER), SUCCESS(ACTION_TYPES.UPDATE_USER)], { data: 'some handsome usertemp' }, types => {
//         expect(types).toMatchObject({
//           updating: false,
//           updateSuccess: true,
//           user: 'some handsome usertemp'
//         });
//       });
//     });
//
//     it('should set state to successful update with an empty usertemp', () => {
